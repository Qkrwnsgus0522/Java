...
public class Test01 {
	...
	public static void main(String[] args) {
		...
		// 1. 구매하기 / 종료하기
		// 2-1. 종료하기 : 프로그램 종료
		// 2-2. 구매하기 : 아메리카노/카페라뗴/아이스티 등의 메뉴를 출력
		// 3. 몇개 구매?
		// 4. 가격안내
		// 5. 현금입력 --> 거스름돈 반환
		// ※ 재고 데이터 O
		...
		while (true) { // 몇번 반복할지 모르기때문
			...
			while (true) {
				...
				num = sc.nextInt();
				// num (지역)변수는 67번의 while블록에서 선언되었기 때문에
				// 92번의 블록을 벗어나면 소멸된다
			...
			int cnt; // 지역변수의 특성
			while (true) { // 유효성 검사 : 구매할 개수가 음수이거나, 재고보다 많이면 안됨
